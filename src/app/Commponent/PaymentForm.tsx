    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex items-center gap-2 mt-4">
            <Image src="/Klarna.png" alt="Klaran"  width={50} height={25} className="rounded-md"/>
            <Image src="/cards.png" alt="card"  width={50} height={25} className="rounded-md"/>
            <Image src="/stripe.png" alt="strip"  width={50} height={25} className="rounded-md"/>
        </div>
      <button
        type="submit"
        className="px-4 py-2 rounded-xl text-white font-semibold flex items-center justify-center gap-2
